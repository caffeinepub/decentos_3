...
function MindMap({
  ...
  const { data: mapData, set: saveMapData } = useCanisterKV(
    "decentos_mindmap",
  ...
  const [activeColor, setActiveColor] = reactExports.useState(NODE_COLORS[1]);
  const [hoveredId, setHoveredId] = reactExports.useState(null);
  const [nodeColorPickerId, setNodeColorPickerId] = reactExports.useState(
    null
  );
  ...
  const deleteNode = (id) => {
    ...
    const collect = (nid) => {
      toDelete.add(nid);
      for (const n of nodes.filter((n2) => n2.parentId === nid)) {
        collect(n.id);
      }
    };
    collect(id);
  ...
  const commitEdit = () => {
    ...
    const updated = nodes.map(
      (n) => n.id === editingId ? { ...n, label: editLabel } : n
    );
  ...
  const [localNodes, setLocalNodes] = reactExports.useState(null);
  const onMouseMove = reactExports.useCallback(
    (e) => {
      ...
      setLocalNodes(
        (prev) => (prev ?? nodes).map(
          (n) => n.id === id ? { ...n, x: e.clientX - offsetX, y: e.clientY - offsetY } : n
        )
      );
    },
    [nodes]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 4, marginLeft: 8 }, children: NODE_COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { marginLeft: "auto", fontSize: 11, color: MUTED }, children: "Double-click node to rename · Drag to move" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Mind map connections" }),
              ...
              displayNodes.map((node) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  className: "mind-node",
                  ...
                  style: {
                    ...
                    border: `2px solid ${selectedId === node.id ? "var(--os-text-secondary)" : node.color}`,
                    borderRadius: 10,
                    ...
                    alignItems: "center",
                    gap: 4,
                    boxShadow: selectedId === node.id ? `0 0 12px ${node.color}` : "none"
                  },
                  children: [
                    editingId === node.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        value: editLabel,
                    ...
                    hoveredId === node.id && editingId !== node.id && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 3, marginLeft: 2 }, children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                      ...
                      node.id !== 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                    ...
                    nodeColorPickerId === node.id && /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          position: "absolute",
                        ...
                        children: NODE_COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            type: "button",
