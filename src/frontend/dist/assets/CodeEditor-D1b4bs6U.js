import { r as reactExports, a2 as reactDomExports, j as jsxRuntimeExports, a3 as ChevronDown, C as Check, a4 as ChevronUp, i as useActor, a as useOSEventBus, n as useListChildren, a5 as useUpdateFileContent, p as useCreateFile, g as ue, X, a6 as Code, m as Copy, k as FolderOpen, S as Search } from "./index-CZGIn5x2.js";
import { B as Button } from "./button-DBwl-7M-.js";
import { P as Portal$1, h as hideOthers, u as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, a as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-BCz03eSL.js";
...
import { u as useLayoutEffect2, c as composeEventHandlers } from "./index-DxR-hlVQ.js";
import { c as createCollection } from "./index-D8sJW3Ik.js";
import { u as useComposedRefs, a as createSlot, c as cn } from "./utils-C29Fbx4G.js";
import { c as createContextScope } from "./index-DfmnWLAm.js";
import { u as useDirection } from "./index-9Nd72esH.js";
import { u as useId } from "./index-uZuUQcbU.js";
import { P as Primitive } from "./index-B9-lQkRo.js";
import { u as useCallbackRef } from "./index-C4X58sdz.js";
import { a as useSize, u as usePrevious } from "./index-DTcg9m71.js";
import { u as useControllableState } from "./index-CY_eMQHg.js";
...
function highlightByKeywords(code, keywords, commentPrefixes, stringPatterns) {
...
function highlightCSS(code) {
  ...
  ).replace(/([\w-]+)\s*:/g, `<span style="color:#27D7E0">$1</span>:`).replace(
    /(:\s*)([^;{}]+)/g,
...
function highlightJSON(code) {
  ...
  ).replace(/\b(true|false|null)\b/g, `<span style="color:#f472b6">$1</span>`).replace(
    /:\s*(-?\d+\.?\d*)/g,
...
function highlightShell(code) {
  return escapeHtml(code).replace(
    /#.*/g,
    (c) => `<span style="color:#5a7a5a;font-style:italic">${c}</span>`
  ).replace(/\$(\w+)/g, `<span style="color:#27D7E0">$$$1</span>`).replace(
...
function highlightMarkdown(code) {
  ...
  ).replace(/\*([^*]+)\*/g, `<em style="color:#a8d4a0">*$1*</em>`).replace(
    /^([ \t]*[-*+][ \t]+)/gm,
    (m) => `<span style="color:#f472b6">${m}</span>`
  ).replace(
    /^([ \t]*\d+\.[ \t]+)/gm,
    (m) => `<span style="color:#e6c07b">${m}</span>`
  ).replace(/`([^`]+)`/g, `<span style="color:#fbbf24">\`$1\`</span>`).replace(
    /^(>[ \t].*)/gm,
...
function CodeEditor() {
  const newTab = (file, content2 = "", lang = "plaintext") => ({
    id: `tab-${Date.now()}-${Math.random()}`,
    file,
    content: content2,
    savedContent: content2,
    language: lang,
    label: (file == null ? void 0 : file.name) ?? "Untitled"
  });
  const [tabs, setTabs] = reactExports.useState([newTab(null)]);
  ...
  const [savedContent, setSavedContent] = reactExports.useState("");
  ...
  const [showOrientationCard, setShowOrientationCard] = reactExports.useState(
    () => {
      try {
        return localStorage.getItem("decentos_codeeditor_orientation_shown") !== "true";
      } catch {
        return true;
      }
    }
  );
  const [showNewFile, setShowNewFile] = reactExports.useState(false);
  ...
  const [searchMatchCount, setSearchMatchCount] = reactExports.useState(0);
  const [cursorLine, setCursorLine] = reactExports.useState(1);
  const [cursorCol, setCursorCol] = reactExports.useState(1);
  ...
  const lineNumbersRef = reactExports.useRef(null);
  ...
  const handleOpen = reactExports.useCallback((file) => {
    setOpenFile(file);
  ...
  reactExports.useEffect(() => {
    ...
    try {
      ...
      setSearchMatchCount((matches == null ? void 0 : matches.length) ?? 0);
    } catch {
      setSearchMatchCount(0);
    }
  }, [searchQuery, content]);
  ...
  const handleSave = reactExports.useCallback(async () => {
    ...
    try {
      ...
      ue.success("File saved");
    } catch {
      ue.error("Save failed");
    }
  }, [openFile, content, updateFileMutation]);
  const loadCloudCodeFiles = reactExports.useCallback(async () => {
    if (!actor) return;
    setCloudFilesLoading(true);
    try {
      const files2 = await actor.getFileMetadata();
      setCloudFiles(files2.filter((f) => f.mimeType.startsWith("text/")));
    } catch {
    } finally {
  ...
  const saveToCloud = reactExports.useCallback(async () => {
    var _a;
    if (!actor) return;
    const ext = language === "typescript" ? ".ts" : language === "javascript" ? ".js" : language === "motoko" ? ".mo" : language === "python" ? ".py" : language === "rust" ? ".rs" : language === "html" ? ".html" : language === "css" ? ".css" : language === "json" ? ".json" : ".txt";
    const fileName = (((_a = openFile == null ? void 0 : openFile.name) == null ? void 0 : _a.replace(/\.[^.]+$/, "")) || "code") + ext;
  ...
  const handleCopy = reactExports.useCallback(() => {
    ...
    ue.success("Code copied to clipboard", { duration: 1500 });
  }, [content]);
  const handleCreateNew = reactExports.useCallback(async () => {
    ...
    try {
      ...
      setNewFileName("");
      ue.success(`Created ${name}`);
    } catch {
      ue.error("Failed to create file");
    }
  ...
  const syncScroll = reactExports.useCallback(() => {
  ...
  const onlyFiles = files.filter((f) => f.nodeType === "file");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        tabs.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    ...
                    borderBottom: activeTabId === tab.id ? "2px solid rgba(39,215,224,0.7)" : "2px solid transparent",
                    background: activeTabId === tab.id ? "rgba(39,215,224,0.06)" : "transparent",
                    maxWidth: 160
                  },
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        ...
                        style: {
                          color: activeTabId === tab.id ? "rgba(39,215,224,0.9)" : "var(--os-text-muted)"
                        },
                        children: [
                          tab.label,
                          tab.content !== tab.savedContent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-amber-400", children: "●" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-4 h-4 os-cyan-text flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono os-cyan-text truncate flex-1", children: [
                openFile ? openFile.name : "Untitled",
                isModified && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 text-amber-400", children: "●" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.keys(LANGUAGE_LABELS).map((lang) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: lang, className: "text-xs", children: LANGUAGE_LABELS[lang] }, lang)) })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FilePlus, { className: "w-3.5 h-3.5 mr-1" }),
                    "New"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(FolderOpen, { className: "w-3.5 h-3.5 mr-1" }),
                    "Open"
                  ]
                }
              ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  ...
                  children: [
                    isCloudSaving ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 mr-1 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { className: "w-3.5 h-3.5 mr-1" }),
                    "Cloud"
                  ]
                }
              )
        ...
        showSearch && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              searchQuery && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "span",
                {
                  ...
                  style: {
                    color: searchMatchCount > 0 ? "rgba(39,215,224,0.7)" : "rgba(248,113,113,0.7)"
                  },
                  children: [
                    searchMatchCount,
                    " match",
        ...
        openFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden font-mono text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ref: lineNumbersRef,
              ...
              children: lineNumbers.map((num) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
`
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                ...
                onClick: (e) => {
                  ...
                  setCursorCol((((_a = lines[lines.length - 1]) == null ? void 0 : _a.length) ?? 0) + 1);
                },
                onSelect: (e) => {
                  var _a;
                  const ta = e.currentTarget;
          ...
          "div",
          {
            ...
            children: [
              showOrientationCard && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground/50 text-sm text-center px-8", children: "Open a file from File Manager or create a new one" }),
        ...
        openFile && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(39,215,224,0.6)" }, children: LANGUAGE_LABELS[language] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--os-text-muted)" }, children: "UTF-8" }),
              isModified && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#FEBC2E" }, children: "unsaved" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showFilePicker, onOpenChange: setShowFilePicker, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            className: "max-w-sm",
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-sm os-cyan-text", children: "Open File" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "h-64", children: onlyFiles.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground/50 text-xs text-center py-8", children: "No files found" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: onlyFiles.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { className: "w-3 h-3 os-cyan-text flex-shrink-0" }),
                    f.name
                  ]
                },
                f.id
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showNewFile, onOpenChange: setShowNewFile, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          DialogContent,
          {
            className: "max-w-sm",
            style: {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-sm os-cyan-text", children: "New File" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "button",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "w-4 h-4", style: { display: "none" } }),
                              "X"
                            ]
                          }
                        )
                    ...
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "button",
                        {
                          ...
                          children: [
                            isCloudSaving ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-3.5 h-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Cloud, { className: "w-3.5 h-3.5" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: cloudFilesLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No code files in cloud" })
                      ]
                    }
